...
- No navbar link for now — will be added in a future iteration
...
**Excluded from sitemap**: `merci.html`, `mentions-legales.html`, `reservation.html`, `quizz/panneaux/*`
...
- **JSON-LD schemas** in use: `FAQPage` (faq.html), `BreadcrumbList` (formules), `BlogPosting` (articles)
